---
name: quay
description: Use when asked to manage Nix flakes, quay manifests, dev shells, or repo-local file syncs like .quay.toml.
---
...
- Global configurations are at `~/dev/lab/quays/*/flake.nix` by default.
